...
/* Definitions for semiAutoTask */
osThreadId_t semiAutoTaskHandle;
const osThreadAttr_t semiAutoTask_attributes = {
  .name = "semiAutoTask",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityHigh1,
};
/* Definitions for semiAutoEvt */
osEventFlagsId_t semiAutoEvtHandle;
const osEventFlagsAttr_t semiAutoEvt_attributes = {
  .name = "semiAutoEvt"
};
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* creation of semiAutoTask */
  semiAutoTaskHandle = osThreadNew(StartSemiAutoTask, NULL, &semiAutoTask_attributes);
  ...
  /* Create the event(s) */
  /* creation of semiAutoEvt */
  semiAutoEvtHandle = osEventFlagsNew(&semiAutoEvt_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Direccion2_Pin|A1_Dir_Pin|A_Dir_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Direccion2_Pin A1_Dir_Pin A_Dir_Pin */
  GPIO_InitStruct.Pin = Direccion2_Pin|A1_Dir_Pin|A_Dir_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/* USER CODE BEGIN Header_StartSemiAutoTask */
/**
* @brief Function implementing the semiAutoTask thread.
* @param argument: Not used
* @retval None
*/
...
void StartSemiAutoTask(void *argument)
{
  ...
  /* USER CODE END StartSemiAutoTask */
}
